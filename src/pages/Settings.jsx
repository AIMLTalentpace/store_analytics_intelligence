...
// // // //   X, Loader2, Undo2, Pencil, Play, ChevronDown, AlertTriangle,
// // // // } from 'lucide-react';
// // // // import './Settings.css';

// // // // // const API = 'http://localhost:5000/api';
// // // // const API = 'https://abs-towns-blocks-contacts.trycloudflare.com/api';
// // // // const CW = 1280;
// // // // const CH = 720;
...
// // // //         <span className="meta-chip"><Monitor size={10} />{cam.type}</span>
...
// // // //               {['IP Camera', 'HTTP Cam', 'USB Camera', 'ONVIF', 'Other'].map(t => (
...
// // // // function CanvasEditor({ cameras, addToast }) {
...
// // // //     fetch(`${API}/camera_snapshot/${selCamId}`)
...
// // // //     fetch(`${API}/cameras/${selCamId}/lines`).then(r => r.json()).then(setLines).catch(() => {});
// // // //     fetch(`${API}/cameras/${selCamId}/zones`).then(r => r.json()).then(setZones).catch(() => {});
// // // //   }, [selCamId, clearAll]);
...
// // // //         for (const l of toDelete) await fetch(`${API}/cameras/${selCamId}/lines/${l.id}`, { method: 'DELETE' });
// // // //       }
// // // //       await fetch(`${API}/cameras/${selCamId}/lines`, {
// // // //         method: 'POST',
// // // //         headers: { 'Content-Type': 'application/json' },
// // // //         body: JSON.stringify({ name: doorName, flip_normal: false, reid: lineReid, gender_age: lineGenderAge, points: pendingLines }),
// // // //       });
// // // //       const refreshed = await fetch(`${API}/cameras/${selCamId}/lines`).then(r => r.json());
// // // //       setLines(refreshed);
// // // //       clearAll();
// // // //       addToast(`"${doorName}" saved`, 'success');
// // // //     } catch { addToast('Failed to save lines', 'error'); }
// // // //     setSaving(false);
// // // //   }, [pendingLines, doorName, lineReid, lineGenderAge, selCamId, editingItem, lines, clearAll, addToast]);
...
// // // //         await fetch(`${API}/cameras/${selCamId}/zones/${editingItem.id}`, { method: 'DELETE' });
// // // //       }
// // // //       await fetch(`${API}/cameras/${selCamId}/zones`, {
// // // //         method: 'POST',
// // // //         headers: { 'Content-Type': 'application/json' },
// // // //         body: JSON.stringify({
// // // //           name,
...
// // // //         }),
// // // //       });
// // // //       const refreshed = await fetch(`${API}/cameras/${selCamId}/zones`).then(r => r.json());
// // // //       setZones(refreshed);
// // // //       clearAll();
// // // //       addToast(`Zone "${name}" saved`, 'success');
// // // //     } catch { addToast('Failed to save zone', 'error'); }
// // // //     setSaving(false);
// // // //   }, [zoneName, zones.length, pendingZonePts, zoneReid, zoneGenderAge, zoneDetectionMode, zoneRoleType, selCamId, editingItem, clearAll, addToast]);
...
// // // //     } else {
// // // //       await fetch(`${API}/cameras/${selCamId}/zones/${confirmDelete.id}`, { method: 'DELETE' });
// // // //       setZones(prev => prev.filter(z => z.id !== confirmDelete.id));
// // // //       addToast('Zone deleted', 'success');
// // // //     }
// // // //     setConfirmDelete(null);
// // // //   }, [confirmDelete, lines, selCamId, addToast]);
...
// // // //         setLoading(false);
// // // //       })
// // // //       .catch(() => { addToast('Failed to load cameras', 'error'); setLoading(false); });
// // // //   }, []);
...
// // // //         method: 'PUT',
// // // //         headers: { 'Content-Type': 'application/json' },
// // // //         body: JSON.stringify({ ...cam, [field]: value }),
// // // //       });
...
// // // //     try {
// // // //       if (editCam) {
// // // //         const res = await fetch(`${API}/cameras/${editCam.id}`, {
// // // //           method: 'PUT',
// // // //           headers: { 'Content-Type': 'application/json' },
...
// // // //           c.id === editCam.id
// // // //             ? { ...c, ...result.camera, connection_status: formData.connection_status ?? result.camera.connection_status ?? c.connection_status ?? 'unknown', tested: formData.tested ?? result.camera.tested, last_tested_at: formData.last_tested_at ?? result.camera.last_tested_at }
// // // //             : c
// // // //         ));
...
// // // //           <p className="settings-sub">Manage cameras, detection lines &amp; zones</p>
// // // //         </div>
...
// // // //               <p className="settings-section-sub">Configure and verify your camera connections</p>
// // // //             </div>
...
// // // //             </div>
// // // //           ) : (
// // // //             <CanvasEditor cameras={cameras} addToast={addToast} />
// // // //           )}
// // // //         </div>
// // // //       )}
// // // //       {showModal && (
...
// // //     if (!selCamId) return;
// // //     setFrameLoading(true); setBgImage(null); clearAll();
// // //     fetch(`${API}/camera_snapshot/${selCamId}`, { headers: authFetchHeaders() })
// // //       .then(r => { if (!r.ok) throw new Error(); return r.blob(); })
// // //       .then(blob => new Promise((res, rej) => {
// // //         const reader = new FileReader();
// // //         reader.onload = () => res(reader.result);
...
// // //       })
// // //       .catch(() => setFrameLoading(false));
// // //     fetch(`${API}/cameras/${selCamId}/lines`, { headers: authFetchHeaders() })
// // //       .then(r => r.json()).then(setLines).catch(() => {});
// // //     fetch(`${API}/cameras/${selCamId}/zones`, { headers: authFetchHeaders() })
...
// // //           await fetch(`${API}/cameras/${selCamId}/lines/${l.id}`, {
// // //             method: 'DELETE',
...
// // //         body: JSON.stringify({ name: doorName, flip_normal: false, reid: lineReid, gender_age: lineGenderAge, points: pendingLines }),
// // //       });
// // //       const refreshed = await fetch(`${API}/cameras/${selCamId}/lines`, { headers: authFetchHeaders() }).then(r => r.json());
// // //       setLines(refreshed);
// // //       clearAll();
// // //       addToast(`"${doorName}" saved`, 'success');
// // //     } catch { addToast('Failed to save lines', 'error'); }
...
// // //     try {
// // //       if (editingItem?.type === 'zone') {
// // //         await fetch(`${API}/cameras/${selCamId}/zones/${editingItem.id}`, {
// // //           method: 'DELETE',
// // //           headers: authFetchHeaders(),
// // //         });
// // //       }
...
// // //         }),
// // //       });
// // //       const refreshed = await fetch(`${API}/cameras/${selCamId}/zones`, { headers: authFetchHeaders() }).then(r => r.json());
// // //       setZones(refreshed);
// // //       clearAll();
// // //       addToast(`Zone "${name}" saved`, 'success');
// // //     } catch { addToast('Failed to save zone', 'error'); }
...
// // //       addToast(`"${confirmDelete.name}" deleted`, 'success');
// // //     } else {
// // //       await fetch(`${API}/cameras/${selCamId}/zones/${confirmDelete.id}`, {
// // //         method: 'DELETE',
// // //         headers: authFetchHeaders(),
// // //       });
// // //       setZones(prev => prev.filter(z => z.id !== confirmDelete.id));
...
// // //       addToast('Camera removed', 'success');
// // //     } catch {
// // //       const restored = await fetch(`${API}/cameras?store=${encodeURIComponent(activeStore)}`, { headers: authFetchHeaders() })
// // //         .then(r => r.json()).catch(() => []);
// // //       setCameras(restored.map(c => ({ ...c, connection_status: c.connection_status || 'unknown' })));
// // //       addToast('Failed to delete camera', 'error');
// // //     }
...
// // activeStore is passed in so every API call targets the correct store
// function CanvasEditor({ cameras, addToast, activeStore }) {
//   const canvasRef = useRef(null);
//   const [selCamId, setSelCamId] = useState(cameras[0]?.id ?? null);
//   const [toolMode, setToolMode] = useState('LINE');
...
//   // Reload snapshot + lines + zones whenever the selected camera or the active store changes.
//   // The ?store= query param ensures admin users hit the right store on the backend.
//   useEffect(() => {
...
//   // Toggles (reid / gender_age / activate)  include store_name so admin writes to the right store
//   const handleToggle = useCallback(async (cam, field, value) => {
//     setCameras(prev => prev.map(c => c.id === cam.id ? { ...c, [field]: value } : c));
//     try {
