...
// } from 'recharts';
// import {
//   Calendar, RefreshCw, MapPin, Users, TrendingUp,
//   AlertTriangle, CheckCircle, ShieldAlert, ShoppingCart, Flame, Store,
// } from 'lucide-react';
// import './Analytics.css';

// const API_BASE = 'https://abs-towns-blocks-contacts.trycloudflare.com';
...
//       fill="#fff"
//       style={{ fontSize: 11, fontFamily: 'DM Mono, monospace', fontWeight: 600, pointerEvents: 'none' }}
//     >
...
//         fontSize: 11, color: '#F06068', fontFamily: 'var(--font-data)', fontWeight: 600,
//       }}>
//         <span style={{
//           width: 6, height: 6, borderRadius: '50%', background: '#F06068',
...
//     );
//   }
//   if (!resolvedTime || resolvedTime === 'N/A') {
...
//   const cashiers = allAlerts.filter(r => r.roleType !== 'security');
//   const security = allAlerts.filter(r => r.roleType === 'security');
...
//                   <td className="col-time" style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
//                     {r.lastSeen}
//                   </td>
...
//                 <span style={{ fontSize: '0.7em', opacity: 0.7, marginLeft: 5, fontWeight: 400 }}>
//                   ({data.peakZone.count.toLocaleString()})
//                 </span>
//               )}
//             </h3>
//           </div>
...
//                 <span style={{ fontSize: '0.7em', opacity: 0.7, marginLeft: 5, fontWeight: 400 }}>
//                   ({data.busiestDay.count.toLocaleString()})
//                 </span>
//               )}
//             </h3>
//           </div>
...
//                   innerRadius="36%"
//                   outerRadius="78%"
//                   paddingAngle={visiblePieData.length > 1 ? 1 : 0}
//                   startAngle={90}
//                   endAngle={-270}
//                   dataKey="value"
//                   stroke="none"
...
//               barCategoryGap="28%"
//               barGap={3}
//               margin={{ top: 2, right: 4, bottom: 0, left: -14 }}
//             >
...
//                 {data.zones.map((z, i) => (
//                   <span key={z} className="badge" style={{
//                     background: `${ZONE_COLORS[i % ZONE_COLORS.length]}14`,
...
//                     fill={`url(#grad-${i})`} name={z} dot={false}
//                     connectNulls={true}
...
//                 <Tooltip content={<ChartTooltip />} cursor={{ stroke: 'rgba(255,255,255,0.05)', strokeWidth: 1 }} />
//                 <Line
//                   type="monotone" dataKey="total" stroke="#00C896" strokeWidth={2} name="Total"
//                   connectNulls={true}
...
//           Cashier Monitoring
//           {absentCashiers > 0 && (
//             <span className="alert-chip"><AlertTriangle size={10} /> {absentCashiers} alert{absentCashiers !== 1 ? 's' : ''}</span>
//           )}
//         </div>
//       </div>
...
//           Security Monitoring
//           {absentGuards > 0 && (
//             <span className="alert-chip"><AlertTriangle size={10} /> {absentGuards} alert{absentGuards !== 1 ? 's' : ''}</span>
//           )}
//         </div>
//       </div>
